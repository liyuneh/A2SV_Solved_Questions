...
**Problem:** [1985C-Good-Prefixes](https://codeforces.com/contest/1985/problem/C)
...
The first line of the input contains a single integer t (1 ≤q t ≤q 10⁴) — the number of test cases.

The first line of each test case contains a single integer n (1 ≤ n ≤ 2 ⋅ 10⁵) — the number of elements in the array.

The second line of each test case contains n integers a_1,a_2,…,a_n (0 ≤ a_i ≤ 10⁹) — the elements of the array.
