...
The first line of each test case contains a single integer n (1 ≤q n ≤q 100) — the length of the array.

The second line of each test case contains n space-separated integers a_i (0 ≤q a_i ≤q 1) — the elements of the array.
