...
-  select an index i (1 ≤ i ≤ n) such that a_i  \gt  0 
...
The first line of each testcase contains an integer n (2 ≤ n ≤ 2 ⋅ 10⁵) — the length of the array a.

The second line of each testcase contains n integers a_1,a_2,…,a_n (-10⁹ ≤ a_i ≤ 10⁹, a_i ≠ 0).
