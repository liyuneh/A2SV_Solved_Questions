...
Let us call a string t alternating if for every i from 1 to n - 1, the condition t_{i} ≠ t_{i + 1} holds.
...
-  choose a substring s_{l}s_{l+1}… s_{r} consisting of at least one character; 
...
-  reverse the chosen substring, that is, transform the string s_{1}s_{2}… s_{l-1}s_{l}s_{l+1}… s_{r}s_{r+1}… s_{n} into s_{1}s_{2}… s_{l-1}s_{r}s_{r-1}… s_{l}s_{r+1}… s_{n}. 
