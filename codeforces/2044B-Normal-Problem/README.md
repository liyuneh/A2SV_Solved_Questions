...
The only line of each test case contains a string a (1 ≤q |a| ≤q 100) — the string Ship observes from outside the store. It is guaranteed that a only contains characters 'p', 'q', and 'w'.
