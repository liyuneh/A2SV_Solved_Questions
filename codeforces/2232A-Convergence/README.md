...
The first line of each test case contains an integer n (2 ≤q n ≤q 100) — the number of friends Alice has.

The second line of each test case contains n integers a_1,a_2,…,a_n (1 ≤q a_i ≤q 10⁹) — the locations of her friends.
