...
-  1 ≤q a_i ≤q 2 ⋅ n for all i from 1 to n. 
-  All elements of the array and the sums of adjacent elements are pairwise distinct. In other words, among the numbers \{a_1, a_2, …, a_n, a_1 + a_2, a_2 + a_3, …, a_{n - 1} + a_n\}, there should not be two equal numbers.
