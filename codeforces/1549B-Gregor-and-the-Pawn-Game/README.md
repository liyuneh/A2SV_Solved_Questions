...
**Problem:** [1549B-Gregor-and-the-Pawn-Game](https://codeforces.com/contest/1549/problem/B)
...
In the second example, Gregor can guarantee that all 4 of his pawns reach the enemy row, by following the colored paths as demonstrated in the diagram below. Remember, only Gregor takes turns in this "game"!
 ...
 ![image](https://espresso.codeforces.com/cfed1a133b4b2a9c7c47103f0985775059debde6.png) In the third example, Gregor's only pawn is stuck behind the enemy pawn, and cannot reach the end.
