...
**Problem:** [1611A-Make-Even](https://codeforces.com/contest/1611/problem/A)
...
Each of the following t lines contains one integer n (1 ≤ n  \lt  10⁹). It is guaranteed that the given number doesn't contain the digit 0.
...
-  Select l=2 and reverse the prefix 387. The number n becomes 837. This number is odd.
-  Select l=3 and reverse the prefix 837. The number n becomes 738. This number is even.It can be shown that 2 is the minimum possible number of operations that Polycarp needs to do with his number to make it even.
