...
**Problem:** [1843A-Sasha-and-Array-Coloring](https://codeforces.com/contest/1843/problem/A)
...
The first line contains one integer t (1 ≤q t ≤q 1000) — the number of test cases.

The first line of each test case contains a single integer n (1 ≤ n ≤ 50) — length of a.

The second line contains n integers a_1, a_2, …, a_n (1 ≤q a_i ≤q 50) — array a.
