...
**Problem:** [129B-Students-and-Shoelaces](https://codeforces.com/contest/129/problem/B)
...
The first line contains two integers *n* and *m* — the initial number of students and laces (![image](https://espresso.codeforces.com/c0f4b517c1454fa53ac04e10a468e8c02ed79905.png)). The students are numbered from 1 to *n*, and the laces are numbered from 1 to *m*. Next *m* lines each contain two integers *a* and *b* — the numbers of students tied by the *i*-th lace (1 ≤ *a*, *b* ≤ *n*, *a* ≠ *b*). It is guaranteed that no two students are tied with more than one lace. No lace ties a student to himself.
