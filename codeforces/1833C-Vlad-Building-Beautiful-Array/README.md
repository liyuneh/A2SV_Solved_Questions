...
**Problem:** [1833C-Vlad-Building-Beautiful-Array](https://codeforces.com/contest/1833/problem/C)
...
The first line of each case contains a single integer n (1 ≤ n ≤ 2 ⋅ 10⁵) — the length of the array a.

The second line of each case contains n positive integers a_1, a_2, …, a_n (1 ≤ a_i ≤ 10⁹) — the elements of the array a.
