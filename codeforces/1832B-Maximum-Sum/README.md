...
**Problem:** [1832B-Maximum-Sum](https://codeforces.com/contest/1832/problem/B)
...
You are given an array a_1, a_2, …, a_n, where all elements are different.
...
-  the first line contains two integers n and k (3 ≤ n ≤ 2 ⋅ 10⁵; 1 ≤ k ≤ 99999; 2k  \lt  n) — the number of elements and operations, respectively. 
-  the second line contains n integers a_1, a_2, …, a_n (1 ≤ a_i ≤ 10⁹; all a_i are different) — the elements of the array. 
Additional constraint on the input: the sum of n does not exceed 2 ⋅ 10⁵.
