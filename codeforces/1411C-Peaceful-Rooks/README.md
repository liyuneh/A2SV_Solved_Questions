...
**Problem:** [1411C-Peaceful-Rooks](https://codeforces.com/contest/1411/problem/C)
...
The first line contains the number of test cases t (1 ≤q t ≤q 10³). Description of the t test cases follows.

The first line of each test case contains two integers n and m — size of the chessboard and the number of rooks (2 ≤q n ≤q 10⁵, 1 ≤q m  \lt  n). Each of the next m lines contains two integers x_i and y_i — positions of rooks, i-th rook is placed in the cell (x_i, y_i) (1 ≤q x_i, y_i ≤q n). It's guaranteed that no two rooks attack each other in the initial placement.
