...
**Problem:** [1549A-Gregor-and-Cryptography](https://codeforces.com/contest/1549/problem/A)
...
Each subsequent line contains the integer P (5 ≤ P ≤ {10}⁹), with P guaranteed to be prime.


**Output**

Your output should consist of t lines. Each line should consist of two integers a and b (2 ≤ a  \lt  b ≤ P). If there are multiple possible solutions, print any.
