...
**Problem:** [1985D-Manhattan-Circle](https://codeforces.com/contest/1985/problem/D)
...
The first line of each test case contains n and m (1 ≤q n ⋅ m ≤q 2 ⋅ 10⁵) — the height and width of the grid, respectively. 

The next n lines contains m characters '.' or '#'. If the character is '#', then the point is part of the manhattan circle.

It is guaranteed the sum of n ⋅ m over all test cases does not exceed 2 ⋅ 10⁵, and there is a whole manhattan circle on the grid.
