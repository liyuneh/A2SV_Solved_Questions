...
**Problem:** [2199A-Game](https://codeforces.com/contest/2199/problem/A)
...
-  the first line contains a single integer k (1 ≤ k ≤ 50) — the maximum number of points that can be scored in a round; 
-  the second line contains two integers a_1 and b_1 (0 ≤ a_1, b_1 ≤ k; a_1 ≠ b_1) — the points scored by Alice and Bob respectively in the first round; 
-  the third line contains two integers a_2 and b_2 (0 ≤ a_2, b_2 ≤ k; a_2 ≠ b_2) — the points scored by Alice and Bob respectively in the second round.
